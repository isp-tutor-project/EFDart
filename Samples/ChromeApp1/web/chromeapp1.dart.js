...
$$.AppWindowBounds = {
  ...
  "super": "ChromeObject",
  get$left: function(_) {
    return this._jsObject.left;
  },
  set$left: function(_, left) {
    this._jsObject.left = left;
  },
  get$width: function(_) {
    return this._jsObject.width;
  },
...
$$.AppWindowAppWindow = {
  ...
  getBounds$0: function() {
    return $.AppWindowBounds$_proxy(this._jsObject.getBounds());
  },
  setBounds$1: function(bounds) {
    return this._jsObject.setBounds($.convertArgument(bounds));
  }
};
...
$$.API_app_window = {
  ...
  "super": "Object",
  current$0: function() {
    return $.AppWindowAppWindow$_proxy(this._jsObject.current());
  },
...
$.main = function() {
  var t1 = $.query$1$x(document, "#sample_text_id");
  t1.textContent = "Click me!";
  $.get$onClick$x(t1).listen$1($.resizeWindow);
};

$.resizeWindow = function($event) {
  var appWindow, bounds, t1, t2;
  appWindow = $.get$chrome().get$app().window.current$0();
  bounds = appWindow.getBounds$0();
  t1 = bounds.get$width(bounds);
  t2 = $.boundsChange;
  if (typeof t2 !== "number")
    throw $.iae(t2);
  bounds.set$width(bounds, t1 + t2);
  t2 = bounds.get$left(bounds);
  t1 = $.$tdiv$n($.boundsChange, 2);
  if (typeof t1 !== "number")
    throw $.iae(t1);
  bounds.set$left(bounds, t2 - t1);
  appWindow.setBounds$1(bounds);
...
$.resizeWindow.call$1 = $.resizeWindow;
$.resizeWindow.$name = "resizeWindow";
$.num = {builtin$cls: "num"};
...
//@ sourceMappingURL=chromeapp1.dart.js.map
